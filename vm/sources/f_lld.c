...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/24 10:46:19 by aleblanc          #+#    #+#             */
/*   Updated: 2016/06/05 10:54:54 by aleblanc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

void	f_lld(t_champion *ch, t_vm *vm, char **arg, char *type)
{
	int		arg1;
	int		val;
	...
	if ((type[0] == IND_CODE || type[0] == DIR_CODE) && type[1] == REG_CODE &&
		check_reg(arg[1]))
	{
		val = convert_nomod(ch, vm, arg[0], type[0]);
